...
- the complete desired pull request projection.
...
typed tuple operations, create specifications, marker operations, and final
minimal updates. Raw Git records, GraphQL JSON, aliases, cursors, and freely
...
The pre-push hook disables itself only for GHerrit's internal publication
command, preventing recursion without disabling other repository hooks.
