...
- the absence of credential prompts or GitHub errors for an empty stack.
...
Large unrelated pull request populations must leave the GraphQL documents,
local evidence set, planner result, and mutation trace unchanged.
