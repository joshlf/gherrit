...
#[test]
fn explicit_unmanaged_returns_while_missing_intent_requires_a_choice() {
    ...
    testutil::assert_success_snapshot!(ctx, ctx.hook_cmd("pre-push"), "explicit_unmanaged_returns");
    ...
    testutil::assert_failure_snapshot!(
        ...
        "implicit_management_requires_choice"
    );
}
