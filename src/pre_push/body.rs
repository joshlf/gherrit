...
pub(super) struct PrBody<'a> {
    ...
    pub latest_version: NonZeroUsize,
...
impl PrBody<'_> {
    ...
    fn write(&self, mut output: impl Write, history_format: HistoryTableFormat) -> fmt::Result {
        let body = gherrit_pr_id_re().replace(self.commit_body, "");
...
mod tests {
    ...
    fn body<'a>(
        ...
        PrBody {
            ...
            current_pr_number,
            latest_version: NonZeroUsize::new(latest_version).unwrap(),
