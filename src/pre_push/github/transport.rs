...
use crate::pre_push::{
    ...
    local::GherritPrId,
    pull_request::{
        CorrelatedPullRequests, InitialPullRequestIdentities, TerminalExhaustionAccumulator,
        TerminalHistories, correlate_complete,
    },
    remote::RemoteHeads,
};
...
impl Github {
    ...
    pub(in crate::pre_push) async fn observe_legacy_pull_requests(
        ...
        terminal_histories.ensure_legacy_pushable()?;
