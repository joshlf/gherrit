        ...
        let connections = self
            ...
            .map(|(index, query)| {
                let after = query
                    ...
                    .unwrap_or_default();
                format!(
                    "op{index}: pullRequests(headRefName: {}, first: {}{after}, states: [OPEN, CLOSED, MERGED]) {{ nodes {{ number, id, title, body, baseRefName, baseRefOid, headRefName, headRefOid, state, isDraft, isCrossRepository, autoMergeRequest {{ enabledAt }}, isInMergeQueue }} pageInfo {{ hasNextPage, endCursor }} }}",
    ...
    fn document_binds_each_alias_to_one_exact_head_cursor_and_all_states() {
        ...
        assert_eq!(
            ...
            concat!(
                ...
                "headRefOid, state, isDraft, isCrossRepository, autoMergeRequest { ",
                ...
                "baseRefOid, headRefName, headRefOid, state, isDraft, ",
        ...
        assert_eq!(
            ...
            concat!(
                ...
                "headRefName, headRefOid, state, isDraft, isCrossRepository, ",
