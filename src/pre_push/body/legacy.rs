...
/// Temporary renderer for the active pre-activation publisher.
///
/// The active path cannot supply validated literal first-parent history. Keep
/// this adapter unchanged until the activation commit deletes that path and
/// switches to [`super::StackBodyRecipes`].
