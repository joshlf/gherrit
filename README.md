...
lands, advance your local default branch, remove the merged local root from the
remaining stack, and publish again. For a repository whose default branch is
`main`:
...
landed. Repeat from the new root until the stack is landed.
